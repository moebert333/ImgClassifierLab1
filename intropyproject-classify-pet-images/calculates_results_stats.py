...
def calculates_results_stats(results_dic):
    ...
    results_stats_dic['n_correct_dogs'] = num_dog_matches
    results_stats_dic["n_correct_notdogs"] = num_non_matches
    results_stats_dic["n_correct_breed"] = num_breed_matches
